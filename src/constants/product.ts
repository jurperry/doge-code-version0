...
/**
 * The CLI binary name used in all user-facing messages, tips, and error strings.
 * Change this single constant to rebrand the CLI command everywhere.
 */
export const CLI_BINARY_NAME = 'doge'

/**
 * Returns the platform-appropriate binary filename (e.g. "doge.exe" on Windows).
 */
export function getCliBinaryFilename(
